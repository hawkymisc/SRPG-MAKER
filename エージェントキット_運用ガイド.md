...
> **運用ドキュメントの正:** 日常手順は [docs/contributor/agent-workflow.md](docs/contributor/agent-workflow.md) と [docs/contributor/README.md](docs/contributor/README.md) を参照してください。本ファイルはキット同梱時の概要です。
...
```
├── CLAUDE.md                    # 共通プロジェクトメモリ(規約・強制機構・エスカレーション)
├── docs/
